...
--Question 3: Which product code (account type) has the most significant cash flow?
...
-- Question 4: What is the relationship between sex_code and number of transactions
...
SELECT t.channel, ROUND(SUM(t.amt)) as total_transaction_amount
FROM transaction t
JOIN customers c
ON t.cust_id = c.cust_id
GROUP BY t.channel
